...
public class RegcampFrontController {
	...
	public String regcampSearch(HttpServletRequest request, Model model) throws Exception {
		List<regcampDto> regcampSearch = service.regcampSearchDao(request.getParameter("query"), request.getParameter("content"));
	...
	public String regcampDetail(HttpServletRequest request, Model model) throws Exception{
		...
		//캠핑장 편의시설
		List<FacilityDto> regcampFacilityDao = service.regcampFacilityDao(Integer.parseInt(request.getParameter("regSeq")));
