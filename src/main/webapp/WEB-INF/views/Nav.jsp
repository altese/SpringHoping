...
<body>
	...
	<div class="container">
	   <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
	     <a href="homeView" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
	     ...
	     <ul class="nav nav-pills">
	     	<li class="nav-item" style="font-size: 14px;">
	     		...
	     		<a href="hostCheck?cId=<%=session.getAttribute("CID").toString() %>" class="link-dark nav-link">호스트 모드로 전환하기</a>
	     			  <% } %>	
	     	</li>
	     	...
	     	<li class="nav-item">
				...
				<% if (session.getAttribute("CID") == null) { %>
			    <li><a class="dropdown-item" href="cLoginView">로그인</a></li>
			    <li><a class="dropdown-item" href="cJoinView">회원가입</a></li>
			       <% } else { 
			       %>
			    ...
			    <li><a class="dropdown-item" href="cMypage">마이페이지</a></li>
...
<!-- 2022-11-8 Hosik Form tag 이동 및 검색 자체는 가능하게끔 수정, 검색에서 option 값이 잘 안들어가는거 같아서 수정예정임  -->
	...
	<div class="container myscontainer">
      <div class="d-flex align-items-center justify-content-center justify-content-lg-center">
        ...
        <form action="regcampSearch"class="col-12 col-lg-auto mb-4 mb-lg-0 me-lg-4" role="search">
		검색 선택:
		<select name="query">
