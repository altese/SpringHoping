...
<body>
    ...
    <main >
		...
		<div class="row justify-container-center">
			...
			<div class="col-md">
				<img style="margin-bottom: 20px; border-radius: 5px; width: 18rem;"
					src="./images/${images.regImage1}" 
					class="card" alt="...">
			</div>
			<div class="col-md">
				<img style="margin-bottom: 20px; border-radius: 5px; width: 18rem;"
					src="./images/${images.regImage2}" 
					class="card" alt="...">
			</div>
			<div class="col-md">
				<img style="margin-bottom: 20px; border-radius: 5px; width: 18rem;"
					src="./images/${images.regImage3}" 
					class="card" alt="...">
			</div>
        ...
        <% } %>
				...
				<div>
					후기보기 &nbsp;&nbsp;&nbsp;
					<div>후기 평균 : ${reviewAvg.rvStaravg}</div>
					...
					<div class="container">
							...
							<table>
								...
								<c:forEach items="${reviewList}" var="dto">
									<tr class="myhtr">
										...
										<td class="mytd"><a href="reviewDetail?rvSeq=${dto.rvSeq}">${dto.rvTitle}</a></td>
						...
						<a href="reviewWriteView?regSeq=${DetailView.regSeq}&cId=<%=session.getAttribute("CID")%>">후기작성하기</a>
					</div>
				</div>
				</div>
